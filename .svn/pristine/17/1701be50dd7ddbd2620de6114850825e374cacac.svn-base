...
export class RecomendacionesComponent {
  ...
  constructor() {
    ...
    this.columnDefs = [
      {headerName: 'Empresa', field: 'Empresa', pinned: 'left', minWidth: 200, maxWidth: 400, cellStyle:
    ...
    this.rowData = [
      {
        Empresa: 'Nombre de empresa grande a 2 lineas adad aa Nombre de empresa grande a 2 lineas adad aaNombre de empresa grande' +
        ' a 2 lineas' + ' adad aaNombre de empresa grande a 2 lineas adad aaNombre de empresa grande a 2 lineas adad aaNombre de empresa' +
        'grande a 2 lineas' + ' adad Fin ',
        UltimoPrecio: 999999,
